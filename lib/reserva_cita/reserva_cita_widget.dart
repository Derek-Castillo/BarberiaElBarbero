...
import 'reserva_cita_model.dart';
export 'reserva_cita_model.dart';

class ReservaCitaWidget extends StatefulWidget {
  const ReservaCitaWidget({super.key});

  static String routeName = 'reservaCita';
  static String routePath = '/reservaCita';

  @override
  State<ReservaCitaWidget> createState() => _ReservaCitaWidgetState();
}

class _ReservaCitaWidgetState extends State<ReservaCitaWidget> {
  late ReservaCitaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReservaCitaModel());
                            ...
                            onPressed: () async {
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Agendando cita'),
                                    content: Text('Cita agenda'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                              ...
                              context.pushNamed(HistorialCitasWidget.routeName);
                            },
                          ),
                          FlutterFlowIconButton(
                            borderRadius: 8.0,
