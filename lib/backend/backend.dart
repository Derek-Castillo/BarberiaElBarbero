...
import 'schema/barberos_record.dart';
...
export 'schema/barberos_record.dart';
...
/// Functions to query BarberosRecords (as a Stream and as a Future).
Future<int> queryBarberosRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BarberosRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BarberosRecord>> queryBarberosRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BarberosRecord.collection,
      BarberosRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BarberosRecord>> queryBarberosRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
